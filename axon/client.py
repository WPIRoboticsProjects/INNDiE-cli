...
def ensure_ecs_security_group(region):
    ...
    if len(sgs) > 1:
        ...
        sg = sgs[0]
        ensure_ecs_gress(sg["GroupId"], region)
        return sg["GroupId"]
    else:
        sg_id = client.create_security_group(
            Description="Axon autogenerated for ECS.",
            GroupName=sg_name
        )["GroupId"]
...
def ensure_ec2_security_group(region):
    ...
    if len(sgs) > 1:
        ...
        # Assume it has the right permissions
        sg = sgs[0]
        ensure_ec2_gress(sg["GroupId"], region)
        return sg["GroupId"]
    else:
        sg_id = client.create_security_group(
            Description="Axon autogenerated for EC2.",
            GroupName=sg_name
        )["GroupId"]
...
def ensure_task(ecs_client, task_family, region, vcpu, memory):
    ...
    if len(matching_arns) != 0:
        ...
        role_arn = ensure_task_role("axon-ecs-autogenerated-task-role", region)
